...
class TestFailureReason:
    def test_stop_loss_heavy(self):
        trades = [{"type": "sell", "pnl": -100, "pnl_pct": -6.0, "reason": "stop_loss"}] * 5
    ...
    def test_low_win_rate(self):
        trades = [{"type": "sell", "pnl": -100, "pnl_pct": -3.0, "reason": "exit"}] * 5
...
class TestRegimeFit:
    def test_early_period_better(self):
        ...
        curve = [
            ...
            {"date": "2024-01-11", "equity": 120000},
            {"date": "2024-01-21", "equity": 110000},
        ]
    ...
    def test_late_period_better(self):
        curve = [
            {"date": "2024-01-01", "equity": 100000},
            {"date": "2024-01-11", "equity": 95000},
            {"date": "2024-01-21", "equity": 115000},
        ]
        d = diagnose_advanced(_metrics(), [], curve, _strategy())
    ...
    def test_consistent(self):
        curve = [
            {"date": "2024-01-01", "equity": 100000},
            {"date": "2024-01-11", "equity": 108000},
            {"date": "2024-01-21", "equity": 118000},
        ]
        d = diagnose_advanced(_metrics(), [], curve, _strategy())
...
class TestSuggestedParameterChanges:
    ...
    def test_raise_take_profit(self):
        ...
        trades = [{"type": "sell", "pnl_pct": 2.0, "reason": "take_profit"}] * 5
        d = diagnose_advanced(
